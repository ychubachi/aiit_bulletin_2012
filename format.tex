...
\eauthor{Taro Sangi$^{*}$ and Hanako Sangi$^{**}$}
\eabstract{
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{center}
\scalebox{.21}{\includegraphics{aiit_logo.eps}}
\figcaption{図のキャプション}
\label{fig:VFS}
\end{center}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% 気が付いたらgitのメッセージが文字化け・・・おかしいな。
%% git は githubを使うか・・・
%% Eclipse で workspaceにインポートして利用
...
\footnotetext{\hspace{-2em}% 送付日
  Received on September 25, 2010.}
\footnotetext{\hspace{-2em}% 著者所属 2
 $^{*}$ 産業技術大学院大学 産業技術研究科, School of Industrial Technology, Advanced Institute
 of Industrial Technology} \footnotetext{\hspace{-2em}% 著者所属 1
 $^{**}$ 首都大学東京，システムデザイン研究科, Graduate School of System Design, Tokyo
