...
\author{中 鉢 欣 秀$^{*}$}
\etitle{Co-creative Software Development}
...
lacus nulla, dapibus ac placerat sed, aliquam sit amet eros. Morbi eu elit.}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{center}
\scalebox{.2}{\includegraphics{aiit_logo.eps}}
\figcaption{図のキャプション}
\label{fig:VFS}
\end{center}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
