...
\usepackage[dvipdfm]{graphicx} % 図の取り込み(PDF対応)用
\usepackage{mediabb} % PDF画像サイズ取得用
...
\subsection{コ・クリエイティブなソフトウェア開発}
	...
	%###
    コ・クリエイション
    \footnote{co-creation．日本語では「共創」と訳すことが多いが，本研究では「協創」と表記する．}
    とは，マーケティング分野の用語であり，
    ...
    ソフトウェア・プロダクトを開発事例が数多く存在する．OSSの開発では利用者と開発者とが協創的に
...
\begin{figure}
\begin{center}
\includegraphics[width=\linewidth]{figs/user_vendor_model.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=\linewidth]{figs/CcSD.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=\linewidth]{figs/scrum.pdf}
