...
% 標題
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{PBLにおける協創型ソフトウェア開発モデルへのアプローチ}
\author{中 鉢 欣 秀$^{*}$}
\etitle{An Approarch to Co-creative Software Development Model in PBL}
...
technology are changing rapidly.  In Japan, so-called ``User vs. Vendor model'' is
...
%% 著者の所属を記入してください
\footnotetext{\hspace{-4.5ex}% 著者所属 1
...
\caption{コ・クリエイティブなソフトウェア開発チームの振る舞い}\label{fig:CcSD}
\end{center}
\end{figure}
